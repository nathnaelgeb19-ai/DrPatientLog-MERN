...
function Shell({doctor,onLogout,children}){
  ...
  const nav=[
    ...
    ...(doctor.role==='admin'
      ?[['/doctors','Doctors',UserRoundCog],['/backup','Backup',Database],['/settings','Settings',Settings]]
      :[])
  ];
